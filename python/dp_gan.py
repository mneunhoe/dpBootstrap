...
class AdultDataset(Dataset):
  def __init__(self):
    self.data = np.genfromtxt("/Users/marcelneunhoeffer/Desktop/github/private-pgm/data/adult.csv", delimiter = ",", skip_header = 1)
...
def train_step(d_net, g_net, d_optim, g_optim, clipper, noise_dim, data, dataset):
...
def setup_dp_gan(epochs, epsilon, noise_dim, dataloader):
  
  data_dim = dataloader.dataset.data.shape[1]
  n = dataloader.dataset.data.shape[0]
  
  g_net = Generator(noise_dim = noise_dim, data_dim = data_dim,  hidden_units=(64, 64))

  d_net = Discriminator(data_dim = data_dim, hidden_units=(64, 64), prob = False, dropout_rate=0)
...
def training_loop(epochs, dataloader, dataset, d_net, g_net, d_optim, g_optim, clipper, noise_dim):
    for epoch in range(epochs):
    # For each batch in the dataloader
      for i, data in enumerate(dataloader, 0):
        train_step(d_net, g_net, d_optim, g_optim, clipper, noise_dim, data, dataset)
